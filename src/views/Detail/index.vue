...
import { GoodDetail, sku } from '@/api/model/detailModel';
...
const addCart = () =>{
  if(skuObj.skuId){
    ...
    ElMessage({type:'warning', message:'商品规格没有选择'});
  }
}
    ...
    <div class="container" v-if="good.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/sub/${good.categories[1].id}` }">
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <ImageView :image-list="good.mainPictures"></ImageView>
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxSku :goods="good" @change="skuChange"></XtxSku>
              <!-- 数据组件 -->
