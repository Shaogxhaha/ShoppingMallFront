...
import { CategoryChildren } from '@/api/model/categoryModel'
import { useRoute } from 'vue-router';
import GoodsItem from '../Home/components/GoodsItem.vue';
import { NavigationDataRequest, NavigationGoodList } from '@/api/model/categoryModel'

const route = useRoute();
const categoryData = ref({} as CategoryChildren);
